-- =============================================================================
-- BACKUP -- definiciones originales (sin SET search_path) de las 14 funciones
-- marcadas por Supabase Security Advisor como function_search_path_mutable.
-- Solo lectura / referencia. Capturadas en vivo el 2026-07-28, antes de aplicar
-- fix-search-path-functions-20260728.sql. Ninguna es SECURITY DEFINER (verificado
-- contra pg_proc.prosecdef antes de esta captura) -- el riesgo de privilege
-- escalation es bajo, pero se corrige por buena práctica recomendada por Supabase.
-- =============================================================================
